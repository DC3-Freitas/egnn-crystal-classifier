...
from egnn_crystal_classifier.nequip.ml_model.edge_embed import bessel
from egnn_crystal_classifier.nequip.ml_model.interaction import InteractionCore
...
class NequIP(nn.Module):
    ...
    The implementation assumes all irreps have even parity.
    """
    ...
    def __init__(
        ...
        Args:
            config: Includes all information necessary to construct the model.
                    See NequIPConfig class for more details.
        """
        super().__init__()
